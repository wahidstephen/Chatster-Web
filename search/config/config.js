...
exports.FB_URL   = process.env.FB_URL || 'https://chatster-31375.firebaseio.com';
...
exports.FB_SERVICEACCOUNT = process.env.FB_ACC || 'chatster-31375-firebase-adminsdk-knpdy-522520d8ff.json';
